  ...
  return (
    <>
      <div className="bg-green-100 rounded-xl p-4 sm:p-6 md:p-8 lg:p-12 mt-8 sm:mt-10 lg:mt-12">
        <div className="text-center font-roboto font-semibold text-4xl sm:text-5xl md:text-6xl lg:text-7xl mb-6">
          Blogs
        </div>
          ...
          <div className="grid gap-6 sm:gap-8 md:grid-cols-2 lg:grid-cols-3">
            {blogs.map((blog, index) => (
              <div key={index} className="bg-white rounded-lg shadow-md hover:shadow-lg 
                transition-shadow duration-300 transform hover:scale-105 overflow-hidden" >
