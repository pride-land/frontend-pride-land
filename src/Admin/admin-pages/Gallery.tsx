  ...
  return (
    <div className='w-1/2'>
      ...
      <div className="hero-images-container">
        ...
        <FaCircleXmark className="w-10 h-10 text-red-600 bg-black rounded-full absolute top-2 -right-10 cursor-pointer" onClick={() => {setHeroImages(heroImages.filter((selectedImage) => selectedImage.blob_img !== image.blob_img));}}/>
